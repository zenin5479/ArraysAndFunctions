...
// Задача: Даны 4 точки A (x1,y1), B (x2,y2), C (x3, y3), D (x4, y4). Пересекаются ли вектора AB и CD.
// Найти в какой честверти лежит точка пересечения векторов
...
namespace ArraysAndFunctions
{
   internal class Program
   {
      static void Main(string[] args)
      {
         ...
         Console.WriteLine("--------------------------------------------------------------------------------------------------------");
         Console.WriteLine("Напишите программу, на ввод подается номер четверти. Создаются N случайных точек в этой четверти");
